...
barplot(c.fir.tmean ,main = "c.fir.tmean", ylim=c(-0.5,0.5))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
barplot(c.fir.tmin ,main = "c.fir.tmin",ylim=c(-0.5,0.5))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
barplot(c.fir.tmax ,main = "c.fir.tmax",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
barplot(c.fir.precip ,main = "c.fir.precip",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
barplot(c.fir.vpd ,main = "c.fir.vpd",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)

#spruce
par(mfrow=c(2,3), las=3,tck=0.025)
barplot(c.spruce.tmean ,main = "c.spruce.tmean", ylim=c(-0.5,0.5))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
barplot(c.spruce.tmin ,main = "c.spruce.tmin",ylim=c(-0.5,0.5))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
barplot(c.spruce.tmax ,main = "c.spruce.tmax",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
barplot(c.spruce.precip ,main = "c.spruce.precip",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
barplot(c.spruce.vpd ,main = "c.spruce.vpd",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)

#pipo
par(mfrow=c(2,3), las=3,tck=0.025)
barplot(c.pipo.tmean ,main = "c.pipo.tmean", ylim=c(-0.5,0.5))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
barplot(c.pipo.tmin ,main = "c.pipo.tmin",ylim=c(-0.5,0.5))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
barplot(c.pipo.tmax ,main = "c.pipo.tmax",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
barplot(c.pipo.precip ,main = "c.pipo.precip",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
barplot(c.pipo.vpd ,main = "c.pipo.vpd",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
...
par(mfrow=c(2,3), las=3,tck=0.025)
barplot(o.fir.tmean ,main = "o.fir.tmean", ylim=c(-0.5,0.5))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
barplot(o.fir.tmin ,main = "o.fir.tmin",ylim=c(-0.5,0.5))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
barplot(o.fir.tmax ,main = "o.fir.tmax",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
barplot(o.fir.precip ,main = "o.fir.precip",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
barplot(o.fir.vpd ,main = "o.fir.vpd",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)

#spruce
par(mfrow=c(2,3), las=3,tck=0.025)
barplot(o.spruce.tmean ,main = "o.spruce.tmean", ylim=c(-0.5,0.5))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
barplot(o.spruce.tmin ,main = "o.spruce.tmin",ylim=c(-0.5,0.5))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
barplot(o.spruce.tmax ,main = "o.spruce.tmax",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
barplot(o.spruce.precip ,main = "o.spruce.precip",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
barplot(o.spruce.vpd ,main = "o.spruce.vpd",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)

#pipo
par(mfrow=c(2,3), las=3,tck=0.025)
barplot(o.pipo.tmean ,main = "o.pipo.tmean", ylim=c(-0.5,0.5))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
barplot(o.pipo.tmin ,main = "o.pipo.tmin",ylim=c(-0.5,0.5))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
barplot(o.pipo.tmax ,main = "o.pipo.tmax",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
barplot(o.pipo.precip ,main = "o.pipo.precip",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)
barplot(o.pipo.vpd ,main = "o.pipo.vpd",ylim=c(-0.5,0.5))
abline(h = 0.349, lty="dashed", col="red", lwd=2)
abline(h = -0.349, lty="dashed", col="red", lwd=2)