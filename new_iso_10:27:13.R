...
ccf(all.carbon3$dif.c.fir[45:74], snotel$sd.swe[3:32], type="correlation", na.action=na.omit)
...
c.fir.swe <- cor(all.carbon3$dif.c.fir[45:74], snotel[3:32,], method = "pearson")
c.spruce.swe <- cor(all.carbon3$dif.c.spruce[45:74], snotel[3:32,], method = "pearson")
c.pipo.swe <- cor(all.carbon3$dif.c.pipo[45:74], snotel[3:32,], method = "pearson")
...
o.fir.swe <- cor(all.oxygen2$dif.o.fir[45:74], snotel[3:32,], method = "pearson")
o.spruce.swe <- cor(all.oxygen2$dif.o.spruce[45:74], snotel[3:32,], method = "pearson")
o.pipo.swe <- cor(all.oxygen2$dif.o.pipo[45:74], snotel[3:32,], method = "pearson")

########################
#bar plots
#fir

par(mfrow=c(2,2), las=3,tck=0.025)
barplot(c.fir.tmean[,2:18] ,main = "c.fir.tmean", ylim=c(-0.8,0.8), col=ifelse(c.fir.tmean[,2:18] > 0.367 |  c.fir.tmean[,2:18] < -0.367, "blue", "white"))
...
#abline(h = 0.367, lty="dashed", col="red", lwd=2)
#abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(c.fir.precip[,2:18] ,main = "c.fir.precip",ylim=c(-0.8,0.8), col=ifelse(c.fir.precip[,2:18] > 0.367 |  c.fir.precip[,2:18] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(c.fir.vpd[,2:15] ,main = "c.fir.vpd",ylim=c(-0.8,0.8), col=ifelse(c.fir.vpd[,2:15] > 0.367 |  c.fir.vpd[,2:15] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(c.fir.swe[,2] ,main = "c.fir.swe",ylim=c(-0.8,0.8), col=ifelse(c.fir.swe[,2] > 0.355 |  c.fir.swe[,2] < -0.355, "blue", "white"))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
                              
#spruce
par(mfrow=c(2,2), las=3,tck=0.025)
barplot(c.spruce.tmean[,2:18] ,main = "c.spruce.tmean", ylim=c(-0.8,0.8), col=ifelse(c.spruce.tmean[,2:18] > 0.367 |  c.spruce.tmean[,2:18] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
...
#abline(h = 0.367, lty="dashed", col="red", lwd=2)
#abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(c.spruce.precip[,2:18] ,main = "c.spruce.precip",ylim=c(-0.8,0.8), col=ifelse(c.spruce.precip[,2:18] > 0.367 |  c.spruce.precip[,2:18] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(c.spruce.vpd[,2:15] ,main = "c.spruce.vpd",ylim=c(-0.8,0.8), col=ifelse(c.spruce.vpd[,2:15] > 0.367 |  c.spruce.vpd[,2:15] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(c.spruce.swe[,2] ,main = "c.spruce.swe",ylim=c(-0.8,0.8), col=ifelse(c.spruce.swe[,2] > 0.355 |  c.spruce.swe[,2] < -0.355, "blue", "white"))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)

#pipo
par(mfrow=c(2,2), las=3,tck=0.025)
barplot(c.pipo.tmean[,2:18] ,main = "c.pipo.tmean", ylim=c(-0.8,0.8), col=ifelse(c.pipo.tmean[,2:18] > 0.367 |  c.pipo.tmean[,2:18] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
...
#abline(h = 0.367, lty="dashed", col="red", lwd=2)
#abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(c.pipo.precip[,2:18] ,main = "c.pipo.precip",ylim=c(-0.8,0.8), col=ifelse(c.pipo.precip[,2:18] > 0.367 |  c.pipo.precip[,2:18] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(c.pipo.vpd[,2:15] ,main = "c.pipo.vpd",ylim=c(-0.8,0.8), col=ifelse(c.pipo.vpd[,2:15] > 0.367 |  c.pipo.vpd[,2:15] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(c.pipo.swe[,2] ,main = "c.pipo.swe",ylim=c(-0.8,0.8), col=ifelse(c.pipo.swe[,2] > 0.355 |  c.pipo.swe[,2] < -0.355, "blue", "white"))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
...
par(mfrow=c(2,2), las=3,tck=0.025)
barplot(o.fir.tmean[,2:18] ,main = "o.fir.tmean", ylim=c(-0.8,0.8), col=ifelse(o.fir.tmean[,2:18] > 0.367 |  o.fir.tmean[,2:18] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
...
#abline(h = 0.367, lty="dashed", col="red", lwd=2)
#abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(o.fir.precip[,2:18] ,main = "o.fir.precip",ylim=c(-0.8,0.8), col=ifelse(o.fir.precip[,2:18] > 0.367 |  o.fir.precip[,2:18] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(o.fir.vpd[,2:15] ,main = "o.fir.vpd",ylim=c(-0.8,0.8), col=ifelse(o.fir.vpd[,2:15] > 0.367 |  o.fir.vpd[,2:15] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(o.fir.swe[,2] ,main = "o.fir.swe",ylim=c(-0.8,0.8), col=ifelse(o.fir.swe[,2] > 0.355 |  o.fir.swe[,2] < -0.355, "blue", "white"))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
...
#spruce
par(mfrow=c(2,2), las=3,tck=0.025)
barplot(o.spruce.tmean[,2:18] ,main = "o.spruce.tmean", ylim=c(-0.8,0.8), col=ifelse(o.spruce.tmean[,2:18] > 0.367 |  o.spruce.tmean[,2:18] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
...
#abline(h = 0.367, lty="dashed", col="red", lwd=2)
#abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(o.spruce.precip[,2:18] ,main = "o.spruce.precip",ylim=c(-0.8,0.8), col=ifelse(o.spruce.precip[,2:18] > 0.367 |  o.spruce.precip[,2:18] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(o.spruce.vpd[,2:15] ,main = "o.spruce.vpd",ylim=c(-0.8,0.8), col=ifelse(o.spruce.vpd[,2:15] > 0.367 |  o.spruce.vpd[,2:15] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(o.spruce.swe[,2] ,main = "o.spruce.swe",ylim=c(-0.8,0.8), col=ifelse(o.spruce.swe[,2] > 0.355 |  o.spruce.swe[,2] < -0.355, "blue", "white"))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)
                              
#pipo
par(mfrow=c(2,2), las=3,tck=0.025)
barplot(o.pipo.tmean[,2:18] ,main = "o.pipo.tmean", ylim=c(-0.8,0.8), col=ifelse(o.pipo.tmean[,2:18] > 0.367 |  o.pipo.tmean[,2:18] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
...
#abline(h = 0.367, lty="dashed", col="red", lwd=2)
#abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(o.pipo.precip[,2:18] ,main = "o.pipo.precip",ylim=c(-0.8,0.8), col=ifelse(o.pipo.precip[,2:18] > 0.367 |  o.pipo.precip[,2:18] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(o.pipo.vpd[,2:15] ,main = "o.pipo.vpd",ylim=c(-0.8,0.8), col=ifelse(o.pipo.vpd[,2:15] > 0.367 |  o.pipo.vpd[,2:15] < -0.367, "blue", "white"))
abline(h = 0.367, lty="dashed", col="red", lwd=2)
abline(h = -0.367, lty="dashed", col="red", lwd=2)
barplot(o.pipo.swe[,2] ,main = "o.pipo.swe",ylim=c(-0.8,0.8), col=ifelse(o.pipo.swe[,2] > 0.355 |  o.pipo.swe[,2] < -0.355, "blue", "white"))
abline(h = 0.355, lty="dashed", col="red", lwd=2)
abline(h = -0.355, lty="dashed", col="red", lwd=2)                              


lm1 <- lm(snotel$sd.swe[23:32]~snotel$vl.swe[23:32])
summary(lm1)

plot(all.carbon3$diff.c.fir ~ all.carbon3$year)